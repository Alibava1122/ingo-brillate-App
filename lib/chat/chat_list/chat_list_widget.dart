    ...
    return StreamBuilder<List<ChatRecord>>(
      stream: queryChatRecord(
        queryBuilder: (chatRecord) =>
            chatRecord.orderBy('lasta_message_time', descending: true),
      ),
      builder: (context, snapshot) {
        ...
        List<ChatRecord> chatListChatRecordList = snapshot.data!;
                          ...
                          Expanded(
                            child: TabBarView(
                              ...
                              children: [
                                Builder(
                                  builder: (context) {
                                    final chats = chatListChatRecordList
                                        .where((e) =>
                                            (e.userA == currentUserUid) ||
                                            (e.userB == currentUserUid))
                                        .toList();
